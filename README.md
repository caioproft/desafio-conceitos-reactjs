...
Agora você deve continuar desenvolvendo a aplicação que irá armazenar repositórios do seu portfólio, que foi desenvolvido no desafio de backend utilizando o Node.js.
